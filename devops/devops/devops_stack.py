...
class DevopsStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        table_name = f"{env_name}-pantry"

        logging.info("Environment: %s", env_name)

        pantry_table = dynamodb.Table(
            self,
            id=table_name,
        ...
        search_nutrition_product_lambda_function_name = (
            "search-nutrition-product-function"
        )
        ...
        search_nutrition_products_lambda_function = _lambda.Function(
            ...
            environment={"PRODUCTS_TABLE_NAME": pantry_table.table_name},
        )
